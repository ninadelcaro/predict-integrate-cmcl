...
CUDA_LAUNCH_BLOCKING=1 python test_modified_tuning.py --language $lang --seed ${seed} --delay 0 --min_frequency 24 \
--path_to_model "$(realpath ../u802098/final_models/model_${lang}_0delay_seed_${seed}_epoch_${epoch})" \
--input_data "$(realpath ../u802098/test_set_${lang}_0_delay_${seed}_seed.txt)" 
